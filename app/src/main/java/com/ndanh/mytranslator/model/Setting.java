...
public class Setting {
    ...
    private @DrawableRes int iconSetting;
    private @StringRes int textSetting;
    private @DrawableRes int checkBoxSetting;
    ...
    public @DrawableRes int getIconSetting() {
        return iconSetting;
    }
    ...
    public @DrawableRes int getCheckBoxSetting() {
        return checkBoxSetting;
    }

    public Setting(@DrawableRes int iconSetting, @StringRes int textSetting, @DrawableRes int checkBoxSetting) {
